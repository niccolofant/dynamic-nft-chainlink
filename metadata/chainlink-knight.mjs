...
const knight = {
  ...
  description:
    "Defender against Flash Loan attacks, protector of #Defi protocols. Helping keep the smart contract kingdom secure, reliable, and safe.",
  image: new File(
    [
      await fs.promises.readFile(
        "/Users/niccolofant/dev/Solidity/dndNFT/images/Chainlink_Knight.png"
      ),
    ],
